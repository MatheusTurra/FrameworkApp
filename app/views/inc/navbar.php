<nav class="navbar navbar-expand-lg navbar-light bg-dark mb-3">
  <a class="navbar-brand text-light" href="<?php echo URLROOT; ?>"><?php echo SITENAME; ?></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link text-light" href="<?php echo URLROOT; ?>">Home</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-light" href="<?php echo URLROOT ?>/pages/about">About</a>
      </li>
    </ul>
